movies.sql is a file containing SQL commands to set up and populate data tables of interest, containing entries such as genre, rating, motion picture title, etc.
