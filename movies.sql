...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2021 at 05:24 PM
...
(1, 'Shang-Chi: Legend of the Ten Rings', 8, 'Marvel Studios', 200000000),
(2, 'Free Guy', 7, '20th Century Studios', 125000000),
(3, 'WandaVision', 8, 'Marvel Studios', 225000000),
(4, 'Squid Game', 8, 'Siren Pictures Inc.', 21000000),
(101, 'Breaking Bad', 9, 'High Bridge Productions', 195000000),
(102, 'Band of Brothers', 10, 'DreamWorks', 125000000),
(103, 'Game of Thrones', 9, 'HBO', 480000000),
(104, 'Rick and Morty', 8, 'Green Portal Productions', 52000000),
(105, 'Sherlock', 9, 'BBC', 13000000),
(106, 'Fullmetal Alchemist: Brotherhood', 8, 'Bones', 5500000),
(107, 'Ted Lasso', 7, 'Universal Television', 120000000),
(108, 'Fleabag', 8, 'Two Brothers Pictures', 20000000),
(109, 'The Simpsons', 8, 'Gracie Films', 2147483647),
(110, 'Sacred Games', 7, 'Netflix', 18000000),
...
CREATE TABLE `movie` (
  `mpid` int(11) NOT NULL,
  `boxoffice_collection` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `likes`
  ADD CONSTRAINT `likes_ibfk_1` FOREIGN KEY (`mpid`) REFERENCES `motionpicture` (`id`),
  ADD CONSTRAINT `likes_ibfk_2` FOREIGN KEY (`uemail`) REFERENCES `user` (`email`);
